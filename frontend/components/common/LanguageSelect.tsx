    ...
    <div>
      ...
      <div className="mt-2 rounded-md border border-line bg-white">
        <button
          ...
          className="flex w-full items-center justify-between px-3 py-2 text-left text-sm font-semibold text-ink disabled:opacity-50"
        >
          <span>{value}</span>
          <span className="text-xs uppercase text-accent">{open ? "close" : "change"}</span>
        </button>
        {open ? (
          <div className="border-t border-line p-2">
            <input
              ...
              className="w-full rounded-md border border-line px-3 py-2 text-sm disabled:opacity-50"
            />
